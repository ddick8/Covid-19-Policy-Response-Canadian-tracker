...
Additionally, our dataset was compared to the dataset from Oxford COVID-19 Government Response Tracker. Side by side comparison can be found under [Dataset Comparison2](https://github.com/ddick8/CovidPolicy-Canada/blob/main/Data%20Archive/Dataset%20comparison2.xlsx). We understand that the previous dataset provided by Oxford might be updated and hence it might not match to what our dataset comparison indicates; for clarity, in [Dataset Comparison2](https://github.com/ddick8/CovidPolicy-Canada/blob/main/Data%20Archive/Dataset%20comparison2.xlsx) file, we have highlighted the date when the data was accessed from their repository in yellow.
